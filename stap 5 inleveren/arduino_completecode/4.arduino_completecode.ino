// gebruikte pinnen
    ...
    int knop7 = 0;
    int knop8 = 0;
    int voetgangerwacht= 8;

    // variabelen voor de toestanden
    
    const int GROEP_A = 1; // toestand 1 
    const int GROEP_A1 = 2; // toestand 2
    const int GROEP_A2 = 3; // toestand 3
    const int GROEP_B = 4; // toestand 4
    const int GROEP_B2 = 5; // toestand 5
    const int GROEP_C= 6; // toestand 6
    const int GROEP_D = 7; // toestand 7

    int toestand = GROEP_A1;
    ...
    void loop() {
      ...
      if (toestand == GROEP_A) {
        if (millis() - toestandStartTijd > 10000) {
          ...
          toestand = GROEP_A1;
          Serial.println("Nieuwe toestand: GROEP_A1");
        }
      }


 if (toestand == GROEP_A1) {
    ...
    if (toestand == GROEP_A2) {
      ...
      if (toestand == GROEP_B) {
        ...
        //hieronder staat de code voor het knopje
        if (knop7 == HIGH) {
          toestand = GROEP_A;
 ...
 if (toestand == GROEP_A1) { // TOESTAND 2
     ...
     if (toestand == GROEP_A2) { // TOESTAND 3
      ...
      if (toestand == GROEP_B) { //TOESTAND 4
      ...
      if (toestand == GROEP_B2) { // TOESTAND 5
      ...
      if (toestand == GROEP_C) { // TOESTAND 6
   ...
   if (toestand == GROEP_D) { //TOESTAND 7
